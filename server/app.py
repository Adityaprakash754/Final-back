...
CORS(app, resources={
    r'/api/*': {
        'origins': ['http://localhost:3000', 'https://mivro.org','chrome-extension://nafmjjgfneccfppahalpmbodngjkdfih'],
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=8080, debug=True) # Had to run on different port cause system is using that port 
